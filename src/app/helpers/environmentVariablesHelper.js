...
let envVariables = {
  ...
  CONTENT_URL: env.sunbird_content_player_url || 'http://dock.sunbirded.org/api/',
  CONTENT_PROXY_URL: env.sunbird_content_proxy_url || 'http://dock.sunbirded.org',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'http://dock.sunbirded.org/api/',
